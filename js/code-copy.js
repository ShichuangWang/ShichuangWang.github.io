document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('figure.highlight').forEach((figure) => {
    ...
    // 复制图标（14*15）
    const copyIcon = `
      <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 24 24" fill="white">
    ...
    // 成功后显示的勾
    const checkIcon = `
      <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 24 24" fill="#00cc66">
    ...
    copyBtn.addEventListener('click', () => {
      ...
      navigator.clipboard.writeText(text).then(() => {
        ...
        showTooltip(copyBtn, '已复制', '#00cc66');
        ...
        // 失败
        showTooltip(copyBtn, '复制失败', '#cc0000');
      });
    });
  ...
  function showTooltip(btn, msg, color) {
